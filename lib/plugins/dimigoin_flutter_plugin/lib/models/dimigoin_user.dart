...
extension DimigoinUserTypeExtension on DimigoinUserType {
  String get convertStr {
    switch (this) {
      case DimigoinUserType.student:
        return "S";
      case DimigoinUserType.teacher:
        return "T";
      case DimigoinUserType.outdate:
        return "O";
      case DimigoinUserType.parent:
        return "P";
      case DimigoinUserType.dormitoryTeacher:
        return "D";
      default:
        return "";
    }
...
extension DimigoinPermissionTypeExtension on DimigoinPermissionType {
  String get convertStr {
    switch (this) {
      case DimigoinPermissionType.afterschool:
        return "afterschool";
      case DimigoinPermissionType.afterschoolApplication:
        return "afterschool-application";
      case DimigoinPermissionType.attendance:
        return "attendance";
      case DimigoinPermissionType.auth:
        return "auth";
      case DimigoinPermissionType.circle:
        return "circle";
      case DimigoinPermissionType.circleApplication:
        return "circle-application";
      case DimigoinPermissionType.circleApplicationManagement:
        return "circle-application-management";
      case DimigoinPermissionType.config:
        return "config";
      case DimigoinPermissionType.dets:
        return "dets";
      case DimigoinPermissionType.detsApplication:
        return "dets-application";
      case DimigoinPermissionType.etc:
        return "etc";
      case DimigoinPermissionType.fcm:
        return "fcm";
      case DimigoinPermissionType.file:
        return "file";
      case DimigoinPermissionType.ingangApplication:
        return "ingang-application";
      case DimigoinPermissionType.meal:
        return "meal";
      case DimigoinPermissionType.mentoring:
        return "mentoring";
      case DimigoinPermissionType.mentoringApplication:
        return "mentoring-application";
      case DimigoinPermissionType.notice:
        return "notice";
      case DimigoinPermissionType.outgoManagement:
        return "outgo-management";
      case DimigoinPermissionType.outgoRequest:
        return "outgo-request";
      case DimigoinPermissionType.place:
        return "place";
      case DimigoinPermissionType.timetable:
        return "timetable";
      case DimigoinPermissionType.user:
        return "user";
      case DimigoinPermissionType.dalgeurak:
        return "dalgeurak";
      case DimigoinPermissionType.dalgeurakManagement:
        return "dalgeurak-management";
      default:
        return "";
    }
  }
...
extension DimigoinAccountTypeExtension on String {
  ...
  DimigoinPermissionType get convertDimigoinPermissionType {
    switch (this) {
      case "afterschool":
        return DimigoinPermissionType.afterschool;
      case "afterschool-application":
        return DimigoinPermissionType.afterschoolApplication;
      case "attendance":
        return DimigoinPermissionType.attendance;
      case "auth":
        return DimigoinPermissionType.auth;
      case "circle":
        return DimigoinPermissionType.circle;
      case "circle-application":
        return DimigoinPermissionType.circleApplication;
      case "circle-applcation-management":
        return DimigoinPermissionType.circleApplicationManagement;
      case "config":
        return DimigoinPermissionType.config;
      case "dets":
        return DimigoinPermissionType.dets;
      case "dets-application":
        return DimigoinPermissionType.detsApplication;
      case "etc":
        return DimigoinPermissionType.etc;
      case "fcm":
        return DimigoinPermissionType.fcm;
      case "file":
        return DimigoinPermissionType.file;
      case "ingang-application":
        return DimigoinPermissionType.ingangApplication;
      case "meal":
        return DimigoinPermissionType.meal;
      case "mentoring":
        return DimigoinPermissionType.mentoring;
      case "mentoring-application":
        return DimigoinPermissionType.mentoringApplication;
      case "notice":
        return DimigoinPermissionType.notice;
      case "outgo-management":
        return DimigoinPermissionType.outgoManagement;
      case "outgo-request":
        return DimigoinPermissionType.outgoRequest;
      case "place":
        return DimigoinPermissionType.place;
      case "timetable":
        return DimigoinPermissionType.timetable;
      case "user":
        return DimigoinPermissionType.user;
      case "dalgeurak":
        return DimigoinPermissionType.dalgeurak;
      case "dalgeurak-management":
        return DimigoinPermissionType.dalgeurakManagement;
      default:
        return DimigoinPermissionType.none;
    }
  }
}
...
class DimigoinUser {
  ...
  DimigoinUser.fromJson(dynamic json) {
    ...
    _studentId = (json['serial'].runtimeType == int)
        ? json['serial']
        : (json['serial'] != null ? int.parse(json['serial']) : null);
    if (json['photos'] != null) {
      _photos = [];
